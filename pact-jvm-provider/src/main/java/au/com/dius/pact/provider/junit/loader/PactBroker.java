...
public @interface PactBroker {
   ...
   */
  PactBrokerAuth authentication() default @PactBrokerAuth(scheme = "${pactbroker.auth.scheme:legacy}", username = "${pactbroker.auth.username:}", password = "${pactbroker.auth.password:}");
