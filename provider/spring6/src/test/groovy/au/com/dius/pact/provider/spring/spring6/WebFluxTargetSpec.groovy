...
class WebFluxTargetSpec extends Specification {
  ...
  def 'should prepare get request'() {
    given:
    WebFluxSpring6Target webFluxTarget = new WebFluxSpring6Target(routerFunction)
  ...
  def 'should prepare post request'() {
    ...
    WebFluxSpring6Target webFluxTarget = new WebFluxSpring6Target(postRouterFunction)
  ...
  def 'supports any HTTP interaction'() {
    expect:
    new WebFluxSpring6Target(routerFunction).supportsInteraction(interaction) == result
