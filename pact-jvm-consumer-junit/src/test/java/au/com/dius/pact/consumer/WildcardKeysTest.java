...
public class WildcardKeysTest {
    ...
    public void runTest() throws IOException {
      ...
      assertThat(variant.keySet(), Matchers.is(equalTo((Set<String>)Sets.newHashSet("001"))));
      ...
      assertThat(bundle.keySet(), Matchers.is(equalTo((Set<String>)Sets.newHashSet("001-A"))));
