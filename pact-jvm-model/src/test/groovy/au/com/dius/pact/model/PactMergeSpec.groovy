...
class PactMergeSpec extends Specification {
  ...
  def 'Pact merge should allow different descriptions'() {
    given:
    def newInteraction = new RequestResponseInteraction('different', 'test state', request, response)
  ...
  def 'Pact merge should allow different states'() {
    given:
    def newInteraction = new RequestResponseInteraction('test interaction', 'different', request, response)
  ...
  def 'Pact merge should refuse different requests for identical description and states'() {
    ...
    def newInteraction = new RequestResponseInteraction('test interaction', 'test state', differentRequest, response)
