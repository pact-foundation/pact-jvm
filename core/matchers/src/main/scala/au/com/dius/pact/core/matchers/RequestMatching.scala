...
import au.com.dius.pact.core.matchers.util.CollectionUtils
import au.com.dius.pact.core.model.{Request, RequestResponseInteraction, RequestResponsePact, Response}
import com.typesafe.scalalogging.StrictLogging

import scala.collection.JavaConversions

case class RequestMatching(expectedInteractions: Seq[RequestResponseInteraction]) {
  import au.com.dius.pact.core.matchers.RequestMatching._
