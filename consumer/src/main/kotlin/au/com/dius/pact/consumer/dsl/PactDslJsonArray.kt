 ...
 */
@Suppress("LargeClass", "TooManyFunctions", "SpreadOperator", "ImplicitDefaultLocale")
open class PactDslJsonArray : DslPart {
  ...
  override fun putObjectPrivate(obj: DslPart) {
    ...
    repeat((0 until numberExamples).count()) {
      body.add(obj.body)
    }
  }
  ...
  override fun matchUrl(basePath: String?, vararg pathFragments: Any): PactDslJsonArray {
    ...
    body.add(JsonValue.StringValue(exampleValue))
