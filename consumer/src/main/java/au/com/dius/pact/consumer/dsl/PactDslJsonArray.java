...
public class PactDslJsonArray extends DslPart {
  ...
  public static PactDslJsonBody arrayEachLike(Integer numberExamples) {
    ...
    parent.setNumberExamples(numberExamples);
    parent.getMatchers().addRule("", TypeMatcher.INSTANCE);
    return new PactDslJsonBody(".", "", parent);
  }
  ...
  public PactDslJsonArray eachLike(PactDslJsonRootValue value, int numberExamples) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), TypeMatcher.INSTANCE);
    PactDslJsonArray parent = new PactDslJsonArray(getRootPath(), "", this, true);
    parent.setNumberExamples(numberExamples);
    parent.putObjectPrivate(value);
  ...
  public PactDslJsonArray matchUrl(String basePath, Object... pathFragments) {
    ...
    body.add(Json.toJson(urlMatcher.getExampleValue()));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp(urlMatcher.getRegexExpression()));
    return this;
  }
