...
public class PactDslJsonArray extends DslPart {
  ...
  public PactDslJsonArray(String rootPath, String rootName, DslPart parent, PactDslJsonArray array) {
    ...
    this.setMatchers(array.getMatchers().copyWithUpdatedMatcherRootPrefix(rootPath));
    this.setGenerators(array.getGenerators());
  }
  ...
  public PactDslJsonArray eachLike(DslPart object) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), matchMin(0));
    PactDslJsonArray parent = new PactDslJsonArray(getRootPath(), "", this, true);
  ...
  public PactDslJsonArray minArrayLike(int size, DslPart object) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), matchMin(size));
    PactDslJsonArray parent = new PactDslJsonArray(getRootPath(), "", this, true);
  ...
  public PactDslJsonArray maxArrayLike(int size, DslPart object) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), matchMax(size));
    PactDslJsonArray parent = new PactDslJsonArray(getRootPath(), "", this, true);
  ...
  public void putObjectPrivate(DslPart object) {
    for (String matcherName : object.getMatchers().getMatchingRules().keySet()) {
      getMatchers().setRules(getRootPath() + appendArrayIndex(1) + matcherName,
        object.getMatchers().getMatchingRules().get(matcherName));
    }
    getGenerators().addGenerators(object.getGenerators(), getRootPath() + appendArrayIndex(1));
  ...
  public PactDslJsonArray stringType() {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), TypeMatcher.INSTANCE);
    return this;
  }
  ...
  public PactDslJsonArray numberType(Number number) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), new NumberTypeMatcher(NumberTypeMatcher.NumberType.NUMBER));
    return this;
  }
  ...
  public PactDslJsonArray integerType(Long number) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), new NumberTypeMatcher(NumberTypeMatcher.NumberType.INTEGER));
    return this;
  }
  ...
  public PactDslJsonArray decimalType(BigDecimal number) {
    body.add(new JsonValue.Decimal(number.toString().toCharArray()));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), new NumberTypeMatcher(NumberTypeMatcher.NumberType.DECIMAL));
    return this;
  }
  ...
  public PactDslJsonArray stringMatcher(String regex, String value) {
    ...
    body.add(new JsonValue.StringValue(value.toCharArray()));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp(regex));
    return this;
  }
  ...
  public PactDslJsonArray timestamp() {
    ...
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateTimeGenerator(pattern));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTimestamp(pattern));
    return this;
  }
  ...
  public PactDslJsonArray timestamp(String format) {
    ...
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateTimeGenerator(format));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTimestamp(format));
    return this;
  }
  ...
  public PactDslJsonArray date() {
    ...
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateGenerator(pattern));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchDate(pattern));
    return this;
  }
  ...
  public PactDslJsonArray date(String format) {
    ...
    body.add(new JsonValue.StringValue(instance.format(new Date(DATE_2000)).toCharArray()));
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateTimeGenerator(format));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchDate(format));
    return this;
  }
  ...
  public PactDslJsonArray time() {
    ...
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new TimeGenerator(pattern));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTime(pattern));
    return this;
  }
  ...
  public PactDslJsonArray time(String format) {
    FastDateFormat instance = FastDateFormat.getInstance(format);
    body.add(new JsonValue.StringValue(instance.format(new Date(DATE_2000)).toCharArray()));
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new TimeGenerator(format));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTime(format));
    return this;
  }
  ...
  public PactDslJsonArray ipAddress() {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp("(\\d{1,3}\\.)+\\d{1,3}"));
    return this;
  }
  ...
  public PactDslJsonArray unorderedArray() {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), EqualsIgnoreOrderMatcher.INSTANCE);
    return this.array();
  }
  ...
  public PactDslJsonArray unorderedMinArray(int size) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), new MinEqualsIgnoreOrderMatcher(size));
    return this.array();
  }
  ...
  public PactDslJsonArray unorderedMaxArray(int size) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), new MaxEqualsIgnoreOrderMatcher(size));
    return this.array();
  }
  ...
  public PactDslJsonArray unorderedMinMaxArray(int minSize, int maxSize) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), new MinMaxEqualsIgnoreOrderMatcher(minSize, maxSize));
    return this.array();
  }
  ...
  public PactDslJsonArray wildcardArrayMatcher(MatchingRule rule) {
    wildCard = true;
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), rule);
    return this;
  }
  ...
  public PactDslJsonArray hexValue(String hexValue) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp("[0-9a-fA-F]+"));
    return this;
  }
  ...
  public PactDslJsonArray uuid() {
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(1), UuidGenerator.INSTANCE);
  ...
  public PactDslJsonArray uuid(String uuid) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp(UUID_REGEX));
    return this;
  }
  ...
  public static PactDslJsonBody arrayEachLike(Integer numberExamples) {
    ...
    parent.setNumberExamples(numberExamples);
    parent.getMatchers().addRule("", parent.matchMin(0));
    return new PactDslJsonBody(".", "", parent);
  }
  ...
  public static PactDslJsonBody arrayMinLike(int minSize, int numberExamples) {
    ...
    PactDslJsonArray parent = new PactDslJsonArray("", "", null, true);
    parent.setNumberExamples(numberExamples);
    parent.getMatchers().addRule("", parent.matchMin(minSize));
    return new PactDslJsonBody(".", "", parent);
  }
  ...
  public static PactDslJsonBody arrayMaxLike(int maxSize, int numberExamples) {
    ...
    PactDslJsonArray parent = new PactDslJsonArray("", "", null, true);
    parent.setNumberExamples(numberExamples);
    parent.getMatchers().addRule("", parent.matchMax(maxSize));
    return new PactDslJsonBody(".", "", parent);
  }
  ...
  public static PactDslJsonBody arrayMinMaxLike(int minSize, int maxSize, int numberExamples) {
    ...
    PactDslJsonArray parent = new PactDslJsonArray("", "", null, true);
    parent.setNumberExamples(numberExamples);
    parent.getMatchers().addRule("", parent.matchMinMax(minSize, maxSize));
    return new PactDslJsonBody(".", "", parent);
  }
  ...
  public static PactDslJsonArray newUnorderedArray() {
    ...
    root.getMatchers().addRule(root.getRootPath(), EqualsIgnoreOrderMatcher.INSTANCE);
    return root;
  }
  ...
  public static PactDslJsonArray newUnorderedMinArray(int size) {
    PactDslJsonArray root = new PactDslJsonArray();
    root.getMatchers().addRule(root.getRootPath(), new MinEqualsIgnoreOrderMatcher(size));
    return root;
  }
  ...
  public static PactDslJsonArray newUnorderedMaxArray(int size) {
    PactDslJsonArray root = new PactDslJsonArray();
    root.getMatchers().addRule(root.getRootPath(), new MaxEqualsIgnoreOrderMatcher(size));
    return root;
  }
  ...
  public static PactDslJsonArray newUnorderedMinMaxArray(int minSize, int maxSize) {
    ...
    PactDslJsonArray root = new PactDslJsonArray();
    root.getMatchers().addRule(root.getRootPath(), new MinMaxEqualsIgnoreOrderMatcher(minSize, maxSize));
    return root;
  }
  ...
  public PactDslJsonArray includesStr(String value) {
    body.add(new JsonValue.StringValue(value.toCharArray()));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), includesMatcher(value));
    return this;
  }
  ...
  public PactDslJsonArray equalsTo(Object value) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), EqualsMatcher.INSTANCE);
    return this;
  }
  ...
  public PactDslJsonArray and(Object value, MatchingRule... rules) {
    body.add(Json.toJson(value));
    getMatchers().setRules(getRootPath() + appendArrayIndex(0), new MatchingRuleGroup(Arrays.asList(rules), RuleLogic.AND));
    return this;
  }
  ...
  public PactDslJsonArray or(Object value, MatchingRule... rules) {
    body.add(Json.toJson(value));
    getMatchers().setRules(getRootPath() + appendArrayIndex(0), new MatchingRuleGroup(Arrays.asList(rules), RuleLogic.OR));
    return this;
  }
  ...
  public PactDslJsonArray matchUrl(String basePath, Object... pathFragments) {
    ...
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), regexp(regexExpression));
    if (StringUtils.isEmpty(basePath)) {
      getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0),
  ...
  public PactDslJsonArray minMaxArrayLike(int minSize, int maxSize, DslPart object) {
    getMatchers().addRule(getRootPath() + appendArrayIndex(1), matchMinMax(minSize, maxSize));
    PactDslJsonArray parent = new PactDslJsonArray(getRootPath(), "", this, true);
  ...
  public PactDslJsonArray dateExpression(String expression, String format) {
    FastDateFormat instance = FastDateFormat.getInstance(format);
    body.add(new JsonValue.StringValue(instance.format(new Date(DATE_2000)).toCharArray()));
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateGenerator(format, expression));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchDate(format));
    return this;
  }
  ...
  public PactDslJsonArray timeExpression(String expression, String format) {
    FastDateFormat instance = FastDateFormat.getInstance(format);
    body.add(new JsonValue.StringValue(instance.format(new Date(DATE_2000)).toCharArray()));
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new TimeGenerator(format, expression));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTime(format));
    return this;
  }
  ...
  public PactDslJsonArray datetimeExpression(String expression, String format) {
    FastDateFormat instance = FastDateFormat.getInstance(format);
    body.add(new JsonValue.StringValue(instance.format(new Date(DATE_2000)).toCharArray()));
    getGenerators().addGenerator(Category.BODY, getRootPath() + appendArrayIndex(0), new DateTimeGenerator(format, expression));
    getMatchers().addRule(getRootPath() + appendArrayIndex(0), matchTimestamp(format));
    return this;
  }
}
