...
@deprecated("exists to ensure backward compatibility, see au.com.dius.pact.consumer.ConsumerPactSpec for a better example")
class DeprecatedConsumerPactSpec extends Specification {
    isolated
